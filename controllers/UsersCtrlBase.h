...
template<class T=Users>
class UsersCtrlBase : public RestfulController
{
  static_assert(std::is_base_of<Users, T>::value);
  public:
              ...
              })
    {
        ...
        */
        enableMasquerading({
                ...
                "is_banned", // the alias for the is_banned column.
